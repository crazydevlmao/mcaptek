...
/* ====================== CONFIG ====================== */
const COIN_ADDRESS = "9xG36L5qL32g4niAqawGkZ6yThEdL279zZD7LnfeemN5";
const API_BASE =
  import.meta.env.DEV
    ? "http://localhost:3001"
    ...
    <div className="min-h-screen text-white relative overflow-hidden font-[Inter,ui-sans-serif,system-ui]">
      ...
      <header className="absolute top-5 left-0 right-0 flex items-center px-4">
        ...
        <div className="flex gap-2">
          <a
            href="https://x.com/i/communities/1997524968041595332"
            target="_blank"
      ...
      {howOpen && (
        <div className="fixed inset-0 z-50 grid place-items-center">
          ...
          <motion.div
            ...
            className="relative w-[min(92vw,800px)] rounded-2xl overflow-hidden border border-white/12 bg-white/[0.06] backdrop-blur-2xl shadow-[0_20px_70px_rgba(0,0,0,0.55)]"
          >
            <button
